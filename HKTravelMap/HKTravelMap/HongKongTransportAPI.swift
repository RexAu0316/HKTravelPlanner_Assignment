    ...
    class HongKongTransportAPI {
        ...
        private func createMockNearbyTransport(coordinate: CLLocationCoordinate2D, radius: Double) -> [TransportLocation] {
            ...
            return locations.filter { location in
                ...
                let userCoor = CLLocation(latitude: coordinate.latitude, longitude: coordinate.longitude)
                let distance = locationCoor.distance(from: userCoor)
